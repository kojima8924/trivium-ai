...
// CODE: 73 問（difficulty 1〜10・問題タイプ付き）。生成: gpt-5.5 / 検証: Python 実行 + 独立ソルバー gpt-5.5 + レビュー gpt-5.4-mini
...
export const CODE_STOCK: Task[] = [
  ...
  },
  {
    ...
    "hints": [
      "何と何を足しているように見えますか。",
      "数字に見えても、引用符で囲まれているかを見ましょう。",
      "文字どうしを + でつなぐと、計算ではなく連結になります。"
    ],
    "explanation": "\"2\" と \"3\" は引用符で囲まれているので数ではなく文字列です。文字列どうしを + で足すと、計算ではなくつながって \"23\" になります。",
    "skillTags": [
      "debugging",
      "tracing"
    ],
    "choices": [
      "1行目で、\"2\" と \"3\" を文字列として足しているため、つながって表示される。",
      "1行目で、print が計算結果を表示しないため。",
      "1行目で、+ は数字にも文字にも使えないため。",
      "1行目で、3 を先に表示してから 2 を表示しているため。"
    ],
    "answerKey": [
      "0"
    ]
