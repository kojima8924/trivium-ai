...
// CODE: 76 問（difficulty 1〜10・問題タイプ付き）。生成: gpt-5.6-sol / 検証: Python 実行 + 独立ソルバー gpt-5.6-sol + レビュー gpt-5.6-luna
...
export const CODE_STOCK: Task[] = [
  ...
  },
  {
    ...
    "difficulty": 1,
    "title": "係とクラブの集合",
    "passage": "図書係の児童の集合をA、読書クラブの児童の集合をBとします。Aの児童は全員Bにも入っています。",
    "prompt": "この条件を正しく表すベン図はどれですか。",
    "kind": "choice",
    "taskType": "puzzle",
    "hints": [
      "集合Aの児童を一人選ぶと、その児童はどちらの集合にいますか。",
      "すべての図書係が条件を満たせる円の配置を考えましょう。",
      "集合Aだけに入る場所がある配置かどうかを比べてみましょう。"
    ],
    "explanation": "Aの児童は一人残らずBにも入るため、集合Aは集合Bに完全に含まれます。",
    "skillTags": [
      "tracing"
    ],
    "choices": [
      "集合Aと集合Bの円が、重ならずに離れている。",
      "集合Aと集合Bの円が、一部分だけ重なっている。",
      "集合Aの円が、集合Bの円の内側にすべて入っている。",
      "集合Bの円が、集合Aの円の内側にすべて入っている。"
    ],
    "answerKey": [
      "2"
    ]
  ...
  },
  {
    ...
    "difficulty": 8,
    "title": "販促日と平均売上",
    "passage": "ある店舗が、連続する何日かの売上を1万円単位で記録した。全期間の1日平均は54万円だった。販促日だった2日を除くと、残りの日の平均は50万円になった。一方、売上が唯一最低だった日と唯一最高だった日を除くと、残りの日の平均は52万円になった。最高日の売上は最低日の売上の2倍である。また、2日ある販促日の売上の差は12万円で、販促日のうちちょうど1日だけが、最高日または最低日のいずれかと一致していた。",
    "prompt": "全期間の売上合計はいくらか。",
    "kind": "choice",
    "taskType": "math",
    "hints": [
      "平均から、除外された2日分の売上合計を日数の式で表すとどうなるだろうか。",
      "全日数を文字で置き、販促日2日と最高・最低2日の売上合計をそれぞれ表してみよう。",
      "販促日に含まれる日が最高日の場合と最低日の場合を分け、日数が正の整数になるか確かめよう。"
    ],
    "explanation": "全日数をn日とすると、販促日2日の合計は54n−50(n−2)=4n+100万円、最高日と最低日の合計は54n−52(n−2)=2n+104万円である。最低日をL万円とすれば最高日は2L万円なので、3L=2n+104。販促日に最高日が含まれる場合、もう1日は2L−12万円だから、4L−12=4n+100となり、連立するとn=20。最低日が含まれる場合はもう1日がL+12万円となるが、連立するとn=−7となり不可能である。したがって合計は54×20=1,080万円。",
    "skillTags": [
      "algorithms",
      "tracing"
    ],
  ...
  },
  {
    ...
    "difficulty": 8,
    "title": "反転した測量記録",
    "passage": "14地点A〜Nは、東西南北に区切られた地図上の異なる交点にある。隣の交点への移動を1区画とし、経路の交差は許される。\n\n測量者はAから出発し、次の3冊の記録を順につないでAへ戻った。\n\n記録1：Aから東へ4区画進んでB、北へ2区画進んでC、西へ3区画進んでD、南へ1区画進んでE。\n\n記録2：Eから南へ3区画進んでF、東へ2区画進んでG、北へ1区画進んでH、西へ1区画進んでI、北へ1区画進んでJ。\n\n記録3：Jから北へ3区画進んでK、東へ4区画進んでL、南へ1区画進んでM、西へ2区画進んでN、南へ2区画進んでA。\n\nただし、3冊のうちちょうど1冊だけは、方位記号を180度取り違えて記録していた。その1冊では、北と南、東と西をそれぞれ逆向きに読む必要がある。地点名、移動距離、記載順はすべて正しい。",
    "prompt": "実際の地図における地点Lと地点Cの位置関係として、正しいものを選びなさい。",
    "kind": "choice",
    "taskType": "puzzle",
    "hints": [
      "3冊を一周したとき、出発地点と到着地点の関係はどうなるでしょうか。",
      "各記録について、途中の地点ではなく始点から終点までの東西・南北の変位を整理してみましょう。",
      "取り違えた記録を特定した後、Aを基準にCとLまでの経路を別々にたどって比較しましょう。"
    ],
    "explanation": "記録どおりの始点から終点までの変位は、記録1が東1・北1、記録2が東1・南1、記録3が東2である。どれか1冊の変位を反転させて一周の変位を0にできるのは記録3だけ。Aを基準にするとCは東4・北2、反転した記録3をたどったLは西2・南3となる。したがって、LはCより西に6区画、南に5区画にある。",
    "skillTags": [
      "tracing"
    ],
    "choices": [
      "地点Lは地点Cより西に6区画、北に1区画にある。",
      "地点Lは地点Cより西に6区画、南に5区画にある。",
      "地点Lは地点Cより東に2区画、南に5区画にある。",
      "地点Lは地点Cより東に2区画、北に1区画にある。"
    ],
    "answerKey": [
      "1"
    ]
  ...
  },
  {
    ...
    "difficulty": 9,
    "title": "三室の展示配置",
    "passage": "展示物 A、B、C、D、E、F を、赤室・青室・緑室に二つずつ配置する。各展示物は一度だけ使い、同じ室内での並び順は区別しない。配置には次の条件がある。\n\n1. A と B は別の室に置く。\n2. C と D は別の室に置く。\n3. E と F は別の室に置く。\n4. A と同じ室には、D も F も置かない。\n5. 赤室には、A と C のうちちょうど一方を置く。\n6. 青室に B を置くことと、青室に E を置くことは同値である。\n7. D を緑室に置くならば、F を赤室に置く。",
    "prompt": "すべての条件を満たす配置は何通りあるか。",
    "kind": "choice",
    "taskType": "puzzle",
    "hints": [
      "A と同じ室に置ける展示物を、条件に照らして絞り込めますか。",
      "先に三組の同室ペアを決め、その後で各組を三つの室に割り当てると整理しやすくなります。",
      "B と E が別室にある場合、青室について同値条件の真偽が一致するには何が必要かを考えてください。"
    ],
    "explanation": "条件4と条件1から、Aの同室候補はCまたはEです。AとCを組にすると条件5を満たす赤室を作れないため、AとEが同室になります。残りの組分けは「BC・DF」または「BD・CF」です。前者では青室がDFとなり、赤室をAEまたはBCにできるので2通りです。後者では青室がCF、赤室がAE、緑室がBDに決まりますが、条件7に反します。したがって全部で2通りです。",
    "skillTags": [
      "algorithms",
      "tracing"
    ],
  ...
  },
  {
    ...
    "difficulty": 10,
    "title": "異なる回文部分列",
    "passage": "def count_palindromes(s):\n    n = len(s); dp = [[0] * n for _ in range(n)]\n    for i in range(n): dp[i][i] = 1\n    for width in range(2, n + 1):\n        for left in range(n - width + 1):\n            right = left + width - 1\n            if s[left] != s[right]:\n                dp[left][right] = dp[left + 1][right] + dp[left][right - 1] - dp[left + 1][right - 1]\n            else:\n                lo, hi = left + 1, right - 1\n                while lo <= hi and s[lo] != s[left]:\n                    lo += 1\n                while lo <= hi and s[hi] != s[right]:\n                    hi -= 1\n                inner = dp[left + 1][right - 1]\n                if lo > hi:\n                    dp[left][right] = 2 * inner + 2\n                elif lo == hi:\n                    dp[left][right] = 2 * inner + 1\n                else: dp[left][right] = 2 * inner - dp[lo][hi]\n    return dp[0][n - 1]\nprint(count_palindromes('abcaacba'))",
    "prompt": "この関数は、空でない異なる回文部分列の個数を求めるものです。期待する出力は 28 ですが、実際の出力は 26 です。正しい修正を選んでください。",
    "kind": "choice",
    "taskType": "debug",
    "hints": [
      "両端が同じ文字である区間では、内側の同じ文字の個数によって数え方がどう変わるでしょうか。",
      "内側に端と同じ文字が二つ以上ある場合、二倍した集合のどの部分が重複するかを考えてください。",
      "lo と hi 自体を含む区間と、その二点より内側の区間が表す回文を区別してみましょう。"
    ],
    "explanation": "両端と同じ文字が内側に二つ以上ある場合、二重に数えられるのは lo と hi の間にある回文を中央部分とするものです。そのため、lo と hi 自体を除いた dp[lo + 1][hi - 1] を減算します。dp[lo][hi] では余分な回文まで除くため、結果が 26 になります。",
    "skillTags": [
      "debugging",
      "algorithms"
    ],
    "choices": [
      "8行目の減算項を dp[left + 1][right] に変更し、左端を含まない回文の集合だけを除く。",
      "13行目の比較対象を s[left] に変更し、右側から左端と同じ文字だけを探索する。",
      "15行目の参照範囲を dp[left][right - 1] に変更し、右端を除いた回文の総数を基準にする。",
      "20行目の減算項を dp[lo + 1][hi - 1] に変更し、重複する回文の中央部分だけを除く。"
    ],
    "answerKey": [
      "3"
    ]
  },
  {
    ...
    "difficulty": 10,
    "title": "九時間の担当表",
    "passage": "ある区画整備を、A・B・C・Dの4人が交代で行う。作業は9時間で、各時間には1人だけが1時間通して担当する。1時間当たり、Aは3区画、BとCはそれぞれ2区画、Dは1区画を整備する。9時間でちょうど21区画を整備し、BとCの担当時間数は等しく、Dはちょうど1時間担当する。さらに、最初と最後の時間はAが担当し、同じ人が2時間続けて担当することはなく、Bの最初の担当はCの最初の担当より早いものとする。",
    "prompt": "条件をすべて満たす9時間の担当表は何通りあるか。担当者の並びが異なれば別の担当表として数える。",
    "kind": "choice",
    "taskType": "math",
    "hints": [
      "各人の担当時間数は、全時間と総作業量からどう決まるだろうか。",
      "最初と最後の担当を固定したとき、Aの間に入る時間数の分け方を整理してみよう。",
      "BとCの名前を入れ替える対応が、最後の先後条件以外を保つか考えてみよう。"
    ],
    "explanation": "A、B、C、Dの担当時間をa、b、b、1とすると、a+2b+1=9、3a+4b+1=21より、a=4、b=2となる。両端がAでAが連続しないため、並びはAとAの間の3区間に残り5時間を正に分ける形になる。区間長が3・1・1の場合は、同一人物の連続を除く配置が各18通りで、長い区間の選び方を含め54通り。区間長が2・2・1の場合は各20通りで、短い区間の選び方を含め60通り。合計114通りである。BとCを入れ替えると、最初に現れる順序が逆になる担当表と一対一に対応するため、条件を満たすのは114÷2=57通り。",
    "skillTags": [
      "algorithms",
      "tracing"
    ],
