...
**入口は LINE です。** 4 人の AI と会話できるのは LINE だけで、出題・ヒント・寸評・教材の相談もそこで完結します。Web（Dashboard）は、たまった記録を眺めて設定を変える場所です。

<table>
<tr>
<td width="180" align="center">
<a href="https://line.me/R/ti/p/@568xjzcn"><img src="docs/line-qr.png" width="160" alt="Trivium の LINE 公式アカウントを友だち追加する QR コード" /></a>
</td>
<td>

**① LINE で友だち追加** → [@568xjzcn](https://line.me/R/ti/p/@568xjzcn)（スマートフォンで開くと追加画面になります）

追加すると案内役のミチが挨拶と使い方画像を送ります。下のリッチメニューの **READ / WRITE / LOGIC** を押すと、その場で 1 問出ます。詰まったら **💡 ヒント**、気が乗らなければ **パス**。名前で呼べば担当の AI（ヨミ・フミ・ロゴス）と話せます。

**② 記録を残すなら「連携」と送る** → 届いた URL を開いて Google ログイン

連携すると学習が記録され、能力プロフィールが育ちます。連携しなくても会話と説明は動きます。

**③ Web で眺める** → [https://trivium.153.126.213.251.sslip.io](https://trivium.153.126.213.251.sslip.io)

三角形・スコアの推移・実績・XP と、AI 人格や出題タイプの設定。Dashboard の「デモデータを投入」で 10 日分の履歴を入れれば、育った状態をすぐ見られます（学習記録はアカウントごとに独立していて、他の人のデータは見えません）。

</td>
</tr>
</table>

> LINE を使わずに試すこともできます。Web だけでも課題・ヒント・採点・プロフィールはひととおり動きます（会話と日次の総評は LINE 側の機能です）。
